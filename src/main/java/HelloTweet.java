...
public class HelloTweet {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Tweet tweet1 = new Tweet(1, ld1, "UserT", "Get REKT!");
